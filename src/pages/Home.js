    ...
    return (
        <section className='py-32 px-8 md:px-32 md:py-36 md:pt-24 md:pb-24 text-slate-700 dark:bg-slate-900 dark:text-slate-300 transition-colors duration-400'>
                ...
                <motion.p 
                    ...
                    With a rich background in serving both businesses and private clients to research, plan, develop, deliver, improve and fix the product in my care. I bring a unique blend of creativity and technical proficiency to every project. 
