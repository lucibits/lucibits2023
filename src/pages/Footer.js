...
const Footer = () => {
  return (
    <footer className='flex justify-between text-slate-800 px-4 py-12 md:px-32 items-center dark:bg-slate-900 dark:text-slate-300 border-t-[1px] dark:border-0'>
          lucibits &copy; 2024
