...
const Footer = () => {
  return (
    <footer className='flex justify-between text-slate-800 px-4 py-12 md:px-32 items-center dark:bg-[#033F2E] dark:text-slate-300 border-t-[1px] dark:border-green-950'>
          lucibits &copy; 2024
